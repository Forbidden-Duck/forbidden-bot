...
module.exports = async (bot, data) => {
    ...
    if (data) {
        try {
            ...
            bot.Logger.error("DBL Vote : Failed to parse");
        }
        ...
        if (data.type !== "test") {
            ...
            const embed = {
                ...
                fields: [
                    ...
                    { name: "Website", value: "Discord Bot List" },
            ...
            bot.Logger.log("none", `&-3DBL Vote&r : ${userVotes.dbl.votes || 0}`);
        }
    } else {
        bot.Logger.error("DBL Vote: Invalid Data");
    }
}